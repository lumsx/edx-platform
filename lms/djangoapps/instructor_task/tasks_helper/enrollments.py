...
def upload_enrollment_report(_xmodule_instance_args, _entry_id, course_id, _task_input, action_name):
    ...
    for student in students_in_course:
        ...
        enrollment_report_headers = {
            ...
            'City': _('City'),
            'Country': _('Country'),
            'Enrolment Date': _('Enrolment Date'),
            'Currently Enrolled': _('Currently Enrolled'),
            'Enrollment Source': _('Enrolment Source'),
            'Manual (Un)Enrolment Reason': _('Manual (Un)Enrolment Reason'),
            'Enrolment Role': _('Enrolment Role'),
